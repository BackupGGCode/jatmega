...
#define COMMAND_MEMORY_8_SET	0xF1
#define COMMAND_MEMORY_8_GET	0xF2
#define COMMAND_MEMORY_16_SET	0xF3
#define COMMAND_MEMORY_16_GET	0xF4
...
#define RESPONSE_MEMORY_8_SET	0xE1
#define RESPONSE_MEMORY_8_GET	0xE2
#define RESPONSE_MEMORY_16_SET	0xE3
#define RESPONSE_MEMORY_16_GET	0xE4
